...
from nmigen import *
from nmigen_boards.fomu_hacker import FomuHackerPlatform

from blinky import Blinky


class fomu_hacker(Elaboratable):
...
if __name__ == "__main__":
    ...
    if args.simulate:
        ...
        with pysim.Simulator(dut, vcd_file=open("view_fomu_hacker.vcd", "w")) as sim:
            sim.add_clock(1e-3)
