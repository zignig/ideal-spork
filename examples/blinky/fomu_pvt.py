...
from nmigen import *
from nmigen_boards.fomu_pvt import FomuPVTPlatform

from blinky import Blinky


class fomu_pvt(Elaboratable):
...
if __name__ == "__main__":
    ...
    if args.simulate:
        ...
        with pysim.Simulator(dut, vcd_file=open("view_fomu_pvt.vcd", "w")) as sim:
            sim.add_clock(1e-3)
