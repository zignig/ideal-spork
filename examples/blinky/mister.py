...
from nmigen import *
from nmigen_boards.mister import MisterPlatform

from blinky import Blinky


class mister(Elaboratable):
...
if __name__ == "__main__":
    ...
    if args.simulate:
        ...
        with pysim.Simulator(dut, vcd_file=open("view_mister.vcd", "w")) as sim:
            sim.add_clock(1e-3)
