...
from nmigen import *
from nmigen_boards.blackice_ii import BlackIceIIPlatform

from blinky import Blinky


class blackice_ii(Elaboratable):
...
if __name__ == "__main__":
    ...
    if args.simulate:
        ...
        with pysim.Simulator(dut, vcd_file=open("view_blackice_ii.vcd", "w")) as sim:
            sim.add_clock(1e-3)
