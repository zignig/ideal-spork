...
from nmigen import *
from nmigen_boards.kcu105 import KCU105Platform

from blinky import Blinky


class kcu105(Elaboratable):
...
if __name__ == "__main__":
    ...
    if args.simulate:
        ...
        with pysim.Simulator(dut, vcd_file=open("view_kcu105.vcd", "w")) as sim:
            sim.add_clock(1e-3)
